        ...
        <div class="col-md-12 grid-margin stretch-card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            @if (App\Helpers\Helper::adminCan('admin.article.create'))
                                <a href="{{ route('admin.article.create') }}" class="btn btn-danger mb-2"><i
                                        class="mdi mdi-plus-circle mr-2"></i> {{ __('Add Article') }}</a>
                            @endif
                        </div>
                        <div class="col-sm-8">
