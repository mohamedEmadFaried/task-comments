...
class Helper
{
    ...
    public static function productForSelect()
    {
        $data = \App\Models\Product::get(['id', 'name_' . \App::getLocale() . ' as name']);
    ...
    public static function shippingForSelect()
    {
        $data = \App\Models\ShippingCompany::get(['id', 'name_' . \App::getLocale() . ' as name']);

        $returnData = [
            '' => __('Select Shipping Company')
        ];
        foreach ($data as $key => $value) {
            $returnData[$value->id] = $value->name;
        }
    ...
    public static function userForSelect()
    {
        $data = \App\Models\User::get(['id', 'username as name']);
    ...
    public static function paymentForSelect()
    {
        $data = \App\Models\PaymentMethod::get(['id', 'name_' . \App::getLocale() . ' as name']);
    ...
    public static function advPostions()
    {
        $data = \App\Models\AdvPostion::get(['id', 'name']);

        $returnData = [
            '' => __('Select Adv Postion')
        ];
        foreach ($data as $key => $value) {
            $returnData[$value->id] = $value->name;
        }
    ...
    public static function tablePaginationReport()
    {
        return new \App\Libs\TablePaginationReport();
    }
    public static function tableExcel()
    {
        return new \App\Libs\TableExcel();
    }
